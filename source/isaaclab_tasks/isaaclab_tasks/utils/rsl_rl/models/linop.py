...
"""Linear Over-Parameterization (LinOp) architecture for RSL-RL.
...
Robot-agnostic: works for any observation/action dimension.
"""
...
class RslRlLinOpModelCfg(RslRlMLPModelCfg):
    """Drop-in RSL-RL MLP model config that routes to the shared LinOp model."""

    class_name: str = "isaaclab_tasks.utils.rsl_rl.models.linop.LinOpModel"
    linop_num_factors: int = 2
