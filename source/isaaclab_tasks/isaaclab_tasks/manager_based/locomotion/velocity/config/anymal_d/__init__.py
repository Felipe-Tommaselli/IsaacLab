...
gym.register(
    id="Isaac-Velocity-Flat-Anymal-D-LinOp-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.flat_env_cfg:AnymalDFlatEnvCfg",
        "rsl_rl_cfg_entry_point": (
            f"{agents.__name__}.rsl_rl_ppo_linop_cfg:AnymalDFlatPPOLinOpRunnerCfg"
        ),
    },
)
...
gym.register(
    id="Isaac-Velocity-Rough-Anymal-D-Simba-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.rough_env_cfg:AnymalDRoughEnvCfg",
        "rsl_rl_cfg_entry_point": (
            f"{agents.__name__}.rsl_rl_ppo_rough_architecture_cfg:AnymalDRoughPPOSimbaRunnerCfg"
        ),
    },
)

gym.register(
    id="Isaac-Velocity-Rough-Anymal-D-PFO-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.rough_env_cfg:AnymalDRoughEnvCfg",
        "rsl_rl_cfg_entry_point": (
            f"{agents.__name__}.rsl_rl_ppo_rough_architecture_cfg:AnymalDRoughPPOPfoRunnerCfg"
        ),
    },
)

gym.register(
    id="Isaac-Velocity-Rough-Anymal-D-LinOp-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.rough_env_cfg:AnymalDRoughEnvCfg",
        "rsl_rl_cfg_entry_point": (
            f"{agents.__name__}.rsl_rl_ppo_rough_architecture_cfg:AnymalDRoughPPOLinOpRunnerCfg"
        ),
    },
)

gym.register(
    id="Isaac-Velocity-Rough-Anymal-D-Simba-PFO-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.rough_env_cfg:AnymalDRoughEnvCfg",
        "rsl_rl_cfg_entry_point": (
            f"{agents.__name__}.rsl_rl_ppo_rough_architecture_cfg:AnymalDRoughPPOPfoSimbaRunnerCfg"
        ),
    },
)
